# swagger_client.EventServiceApi
...
api_instance = swagger_client.EventServiceApi(swagger_client.ApiClient(configuration))
...
body = swagger_client.IoArgoprojWorkflowV1alpha1Item() # IoArgoprojWorkflowV1alpha1Item | The event itself can be any data.
