...
class IoArgoprojEventsV1alpha1TriggerParameterSource(object):
    ...
    def __init__(self, context_key=None, context_template=None, data_key=None, data_template=None, dependency_name=None, value=None, _configuration=None):  # noqa: E501
        """IoArgoprojEventsV1alpha1TriggerParameterSource - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IoArgoprojEventsV1alpha1TriggerParameterSource, dict):
