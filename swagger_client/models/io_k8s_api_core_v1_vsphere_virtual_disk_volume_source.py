...
class IoK8sApiCoreV1VsphereVirtualDiskVolumeSource(object):
    ...
    def __init__(self, fs_type=None, storage_policy_id=None, storage_policy_name=None, volume_path=None, _configuration=None):  # noqa: E501
    ...
    def volume_path(self, volume_path):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and volume_path is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IoK8sApiCoreV1VsphereVirtualDiskVolumeSource, dict):
