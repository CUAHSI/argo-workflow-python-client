...
class IoK8sApiCoreV1AzureFileVolumeSource(object):
    ...
    def __init__(self, read_only=None, secret_name=None, share_name=None, _configuration=None):  # noqa: E501
    ...
    def share_name(self, share_name):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and share_name is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IoK8sApiCoreV1AzureFileVolumeSource, dict):
