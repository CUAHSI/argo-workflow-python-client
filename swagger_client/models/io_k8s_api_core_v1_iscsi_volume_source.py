...
class IoK8sApiCoreV1ISCSIVolumeSource(object):
    ...
    def __init__(self, chap_auth_discovery=None, chap_auth_session=None, fs_type=None, initiator_name=None, iqn=None, iscsi_interface=None, lun=None, portals=None, read_only=None, secret_ref=None, target_portal=None, _configuration=None):  # noqa: E501
    ...
    def iqn(self, iqn):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and iqn is None:
    ...
    def lun(self, lun):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and lun is None:
    ...
    def target_portal(self, target_portal):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and target_portal is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IoK8sApiCoreV1ISCSIVolumeSource, dict):
