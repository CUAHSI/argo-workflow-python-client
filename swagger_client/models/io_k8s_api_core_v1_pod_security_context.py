...
class IoK8sApiCoreV1PodSecurityContext(object):
    ...
    def __init__(self, fs_group=None, fs_group_change_policy=None, run_as_group=None, run_as_non_root=None, run_as_user=None, se_linux_options=None, seccomp_profile=None, supplemental_groups=None, sysctls=None, windows_options=None, _configuration=None):  # noqa: E501
        """IoK8sApiCoreV1PodSecurityContext - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def fs_group(self):
        """Gets the fs_group of this IoK8sApiCoreV1PodSecurityContext.  # noqa: E501

        A special supplemental group that applies to all containers in a pod. Some volume types allow the Kubelet to change the ownership of that volume to be owned by the pod:  1. The owning GID will be the FSGroup 2. The setgid bit is set (new files created in the volume will be owned by FSGroup) 3. The permission bits are OR'd with rw-rw----  If unset, the Kubelet will not modify the ownership and permissions of any volume. Note that this field cannot be set when spec.os.name is windows.  # noqa: E501

        :return: The fs_group of this IoK8sApiCoreV1PodSecurityContext.  # noqa: E501
        :rtype: int
        """
    ...
    def fs_group_change_policy(self):
        """Gets the fs_group_change_policy of this IoK8sApiCoreV1PodSecurityContext.  # noqa: E501

        fsGroupChangePolicy defines behavior of changing ownership and permission of the volume before being exposed inside Pod. This field will only apply to volume types which support fsGroup based ownership(and permissions). It will have no effect on ephemeral volume types such as: secret, configmaps and emptydir. Valid values are \"OnRootMismatch\" and \"Always\". If not specified, \"Always\" is used. Note that this field cannot be set when spec.os.name is windows.  # noqa: E501

        :return: The fs_group_change_policy of this IoK8sApiCoreV1PodSecurityContext.  # noqa: E501
        :rtype: str
        """
    ...
    def fs_group_change_policy(self, fs_group_change_policy):
        """Sets the fs_group_change_policy of this IoK8sApiCoreV1PodSecurityContext.

        fsGroupChangePolicy defines behavior of changing ownership and permission of the volume before being exposed inside Pod. This field will only apply to volume types which support fsGroup based ownership(and permissions). It will have no effect on ephemeral volume types such as: secret, configmaps and emptydir. Valid values are \"OnRootMismatch\" and \"Always\". If not specified, \"Always\" is used. Note that this field cannot be set when spec.os.name is windows.  # noqa: E501

        :param fs_group_change_policy: The fs_group_change_policy of this IoK8sApiCoreV1PodSecurityContext.  # noqa: E501
        :type: str
        """
    ...
    def run_as_group(self):
        """Gets the run_as_group of this IoK8sApiCoreV1PodSecurityContext.  # noqa: E501

        The GID to run the entrypoint of the container process. Uses runtime default if unset. May also be set in SecurityContext.  If set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence for that container. Note that this field cannot be set when spec.os.name is windows.  # noqa: E501

        :return: The run_as_group of this IoK8sApiCoreV1PodSecurityContext.  # noqa: E501
        :rtype: int
        """
    ...
    def run_as_non_root(self):
        """Gets the run_as_non_root of this IoK8sApiCoreV1PodSecurityContext.  # noqa: E501
        ...
        :return: The run_as_non_root of this IoK8sApiCoreV1PodSecurityContext.  # noqa: E501
        :rtype: bool
        """
    ...
    def run_as_user(self):
        """Gets the run_as_user of this IoK8sApiCoreV1PodSecurityContext.  # noqa: E501

        The UID to run the entrypoint of the container process. Defaults to user specified in image metadata if unspecified. May also be set in SecurityContext.  If set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence for that container. Note that this field cannot be set when spec.os.name is windows.  # noqa: E501

        :return: The run_as_user of this IoK8sApiCoreV1PodSecurityContext.  # noqa: E501
        :rtype: int
        """
    ...
    def se_linux_options(self):
        """Gets the se_linux_options of this IoK8sApiCoreV1PodSecurityContext.  # noqa: E501

        The SELinux context to be applied to all containers. If unspecified, the container runtime will allocate a random SELinux context for each container.  May also be set in SecurityContext.  If set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence for that container. Note that this field cannot be set when spec.os.name is windows.  # noqa: E501

        :return: The se_linux_options of this IoK8sApiCoreV1PodSecurityContext.  # noqa: E501
    ...
    def seccomp_profile(self):
        """Gets the seccomp_profile of this IoK8sApiCoreV1PodSecurityContext.  # noqa: E501

        The seccomp options to use by the containers in this pod. Note that this field cannot be set when spec.os.name is windows.  # noqa: E501

        :return: The seccomp_profile of this IoK8sApiCoreV1PodSecurityContext.  # noqa: E501
        :rtype: IoK8sApiCoreV1SeccompProfile
        """
        return self._seccomp_profile

    @seccomp_profile.setter
    def seccomp_profile(self, seccomp_profile):
        """Sets the seccomp_profile of this IoK8sApiCoreV1PodSecurityContext.

        The seccomp options to use by the containers in this pod. Note that this field cannot be set when spec.os.name is windows.  # noqa: E501

        :param seccomp_profile: The seccomp_profile of this IoK8sApiCoreV1PodSecurityContext.  # noqa: E501
    ...
    def supplemental_groups(self):
        """Gets the supplemental_groups of this IoK8sApiCoreV1PodSecurityContext.  # noqa: E501
        ...
        :return: The supplemental_groups of this IoK8sApiCoreV1PodSecurityContext.  # noqa: E501
        :rtype: list[int]
        """
    ...
    @property
    def sysctls(self):
        """Gets the sysctls of this IoK8sApiCoreV1PodSecurityContext.  # noqa: E501
        ...
        :return: The sysctls of this IoK8sApiCoreV1PodSecurityContext.  # noqa: E501
    ...
    def sysctls(self, sysctls):
        ...
        :type: list[IoK8sApiCoreV1Sysctl]
        """
    ...
    def windows_options(self):
        """Gets the windows_options of this IoK8sApiCoreV1PodSecurityContext.  # noqa: E501

        The Windows specific settings applied to all containers. If unspecified, the options within a container's SecurityContext will be used. If set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence. Note that this field cannot be set when spec.os.name is linux.  # noqa: E501

        :return: The windows_options of this IoK8sApiCoreV1PodSecurityContext.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IoK8sApiCoreV1PodSecurityContext, dict):
