...
class IoArgoprojEventsV1alpha1DataFilter(object):
    ...
    def __init__(self, comparator=None, path=None, template=None, type=None, value=None, _configuration=None):  # noqa: E501
        """IoArgoprojEventsV1alpha1DataFilter - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IoArgoprojEventsV1alpha1DataFilter, dict):
