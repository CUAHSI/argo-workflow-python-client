...
class IoArgoprojEventsV1alpha1AzureEventHubsTrigger(object):
    ...
    def __init__(self, fqdn=None, hub_name=None, parameters=None, payload=None, shared_access_key=None, shared_access_key_name=None, _configuration=None):  # noqa: E501
        """IoArgoprojEventsV1alpha1AzureEventHubsTrigger - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IoArgoprojEventsV1alpha1AzureEventHubsTrigger, dict):
