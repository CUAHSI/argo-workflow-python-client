...
class IoArgoprojEventsV1alpha1StripeEventSource(object):
    ...
    """
    swagger_types = {
        'api_key': 'IoK8sApiCoreV1SecretKeySelector',
        'create_webhook': 'bool',
    ...
    def __init__(self, api_key=None, create_webhook=None, event_filter=None, metadata=None, webhook=None, _configuration=None):  # noqa: E501
        """IoArgoprojEventsV1alpha1StripeEventSource - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IoArgoprojEventsV1alpha1StripeEventSource, dict):
