...
class IoArgoprojEventsV1alpha1S3Artifact(object):
    ...
    def __init__(self, access_key=None, bucket=None, endpoint=None, events=None, filter=None, insecure=None, metadata=None, region=None, secret_key=None, _configuration=None):  # noqa: E501
        """IoArgoprojEventsV1alpha1S3Artifact - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IoArgoprojEventsV1alpha1S3Artifact, dict):
