...
class IoArgoprojWorkflowV1alpha1Condition(object):
    ...
    def __init__(self, message=None, status=None, type=None, _configuration=None):  # noqa: E501
        """IoArgoprojWorkflowV1alpha1Condition - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IoArgoprojWorkflowV1alpha1Condition, dict):
