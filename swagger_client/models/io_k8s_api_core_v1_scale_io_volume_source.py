...
class IoK8sApiCoreV1ScaleIOVolumeSource(object):
    ...
    def __init__(self, fs_type=None, gateway=None, protection_domain=None, read_only=None, secret_ref=None, ssl_enabled=None, storage_mode=None, storage_pool=None, system=None, volume_name=None, _configuration=None):  # noqa: E501
    ...
    def secret_ref(self, secret_ref):
        ...
        """
        if self._configuration.client_side_validation and secret_ref is None:
    ...
    def system(self, system):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and system is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IoK8sApiCoreV1ScaleIOVolumeSource, dict):
