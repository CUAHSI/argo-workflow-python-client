...
class IoArgoprojEventsV1alpha1TriggerTemplate(object):
    ...
    swagger_types = {
        ...
        'conditions': 'str',
        'conditions_reset': 'list[IoArgoprojEventsV1alpha1ConditionsResetCriteria]',
    ...
    def __init__(self, argo_workflow=None, aws_lambda=None, azure_event_hubs=None, conditions=None, conditions_reset=None, custom=None, http=None, k8s=None, kafka=None, log=None, name=None, nats=None, open_whisk=None, pulsar=None, slack=None, _configuration=None):  # noqa: E501
        """IoArgoprojEventsV1alpha1TriggerTemplate - a model defined in Swagger"""  # noqa: E501
        ...
        if conditions_reset is not None:
            self.conditions_reset = conditions_reset
    ...
    def conditions_reset(self):
        """Gets the conditions_reset of this IoArgoprojEventsV1alpha1TriggerTemplate.  # noqa: E501


        :return: The conditions_reset of this IoArgoprojEventsV1alpha1TriggerTemplate.  # noqa: E501
        :rtype: list[IoArgoprojEventsV1alpha1ConditionsResetCriteria]
        """
        return self._conditions_reset

    @conditions_reset.setter
    def conditions_reset(self, conditions_reset):
        """Sets the conditions_reset of this IoArgoprojEventsV1alpha1TriggerTemplate.


        :param conditions_reset: The conditions_reset of this IoArgoprojEventsV1alpha1TriggerTemplate.  # noqa: E501
        :type: list[IoArgoprojEventsV1alpha1ConditionsResetCriteria]
        """

        self._conditions_reset = conditions_reset
    ...
    def kafka(self):
        ...
        Kafka refers to the trigger designed to place messages on Kafka topic. +optional.  # noqa: E501
    ...
    def nats(self):
        ...
        NATS refers to the trigger designed to place message on NATS subject. +optional.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IoArgoprojEventsV1alpha1TriggerTemplate, dict):
