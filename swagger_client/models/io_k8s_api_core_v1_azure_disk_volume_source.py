...
class IoK8sApiCoreV1AzureDiskVolumeSource(object):
    ...
    def __init__(self, caching_mode=None, disk_name=None, disk_uri=None, fs_type=None, kind=None, read_only=None, _configuration=None):  # noqa: E501
    ...
    def disk_uri(self, disk_uri):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and disk_uri is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IoK8sApiCoreV1AzureDiskVolumeSource, dict):
