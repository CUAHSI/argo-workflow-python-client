...
class IoArgoprojEventsV1alpha1ArtifactLocation(object):
    ...
    def __init__(self, configmap=None, file=None, git=None, inline=None, resource=None, s3=None, url=None, _configuration=None):  # noqa: E501
        """IoArgoprojEventsV1alpha1ArtifactLocation - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IoArgoprojEventsV1alpha1ArtifactLocation, dict):
