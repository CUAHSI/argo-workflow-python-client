...
class IoArgoprojWorkflowV1alpha1ArchiveStrategy(object):
    ...
    def __init__(self, _none=None, tar=None, zip=None, _configuration=None):  # noqa: E501
    ...
    @property
    def zip(self):
        """Gets the zip of this IoArgoprojWorkflowV1alpha1ArchiveStrategy.  # noqa: E501


        :return: The zip of this IoArgoprojWorkflowV1alpha1ArchiveStrategy.  # noqa: E501
        :rtype: IoArgoprojWorkflowV1alpha1ZipStrategy
        """
        return self._zip

    @zip.setter
    def zip(self, zip):
        """Sets the zip of this IoArgoprojWorkflowV1alpha1ArchiveStrategy.


        :param zip: The zip of this IoArgoprojWorkflowV1alpha1ArchiveStrategy.  # noqa: E501
