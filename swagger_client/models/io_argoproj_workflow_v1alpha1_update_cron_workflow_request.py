...
class IoArgoprojWorkflowV1alpha1UpdateCronWorkflowRequest(object):
    ...
    def __init__(self, cron_workflow=None, name=None, namespace=None, _configuration=None):  # noqa: E501
        """IoArgoprojWorkflowV1alpha1UpdateCronWorkflowRequest - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IoArgoprojWorkflowV1alpha1UpdateCronWorkflowRequest, dict):
