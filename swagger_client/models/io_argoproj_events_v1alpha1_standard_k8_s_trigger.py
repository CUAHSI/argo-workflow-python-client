...
class IoArgoprojEventsV1alpha1StandardK8STrigger(object):
    ...
    def __init__(self, live_object=None, operation=None, parameters=None, patch_strategy=None, source=None, _configuration=None):  # noqa: E501
        """IoArgoprojEventsV1alpha1StandardK8STrigger - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IoArgoprojEventsV1alpha1StandardK8STrigger, dict):
