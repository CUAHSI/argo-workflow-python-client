...
class IoArgoprojWorkflowV1alpha1S3Artifact(object):
    ...
    def __init__(self, access_key_secret=None, bucket=None, ca_secret=None, create_bucket_if_not_present=None, encryption_options=None, endpoint=None, insecure=None, key=None, region=None, role_arn=None, secret_key_secret=None, use_sdk_creds=None, _configuration=None):  # noqa: E501
    ...
    @property
    def ca_secret(self):
        """Gets the ca_secret of this IoArgoprojWorkflowV1alpha1S3Artifact.  # noqa: E501

        CASecret specifies the secret that contains the CA, used to verify the TLS connection  # noqa: E501

        :return: The ca_secret of this IoArgoprojWorkflowV1alpha1S3Artifact.  # noqa: E501
        :rtype: IoK8sApiCoreV1SecretKeySelector
        """
    ...
    def ca_secret(self, ca_secret):
        """Sets the ca_secret of this IoArgoprojWorkflowV1alpha1S3Artifact.

        CASecret specifies the secret that contains the CA, used to verify the TLS connection  # noqa: E501

        :param ca_secret: The ca_secret of this IoArgoprojWorkflowV1alpha1S3Artifact.  # noqa: E501
        :type: IoK8sApiCoreV1SecretKeySelector
        """
