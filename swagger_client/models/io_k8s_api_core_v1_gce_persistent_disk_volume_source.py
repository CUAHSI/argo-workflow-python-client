...
class IoK8sApiCoreV1GCEPersistentDiskVolumeSource(object):
    ...
    def __init__(self, fs_type=None, partition=None, pd_name=None, read_only=None, _configuration=None):  # noqa: E501
    ...
    def pd_name(self, pd_name):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and pd_name is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IoK8sApiCoreV1GCEPersistentDiskVolumeSource, dict):
