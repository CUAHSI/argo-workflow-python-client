...
class IoArgoprojEventsV1alpha1RateLimit(object):
    ...
    def __init__(self, requests_per_unit=None, unit=None, _configuration=None):  # noqa: E501
        """IoArgoprojEventsV1alpha1RateLimit - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IoArgoprojEventsV1alpha1RateLimit, dict):
