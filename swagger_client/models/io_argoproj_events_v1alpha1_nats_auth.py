...
class IoArgoprojEventsV1alpha1NATSAuth(object):
    ...
    def __init__(self, basic=None, credential=None, nkey=None, token=None, _configuration=None):  # noqa: E501
        """IoArgoprojEventsV1alpha1NATSAuth - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IoArgoprojEventsV1alpha1NATSAuth, dict):
