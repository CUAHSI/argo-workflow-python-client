...
class IoArgoprojEventsV1alpha1Template(object):
    ...
    def __init__(self, affinity=None, container=None, image_pull_secrets=None, metadata=None, node_selector=None, priority=None, priority_class_name=None, security_context=None, service_account_name=None, tolerations=None, volumes=None, _configuration=None):  # noqa: E501
        """IoArgoprojEventsV1alpha1Template - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IoArgoprojEventsV1alpha1Template, dict):
