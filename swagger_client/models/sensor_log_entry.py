...
class SensorLogEntry(object):
    ...
    def __init__(self, dependency_name=None, event_context=None, level=None, msg=None, namespace=None, sensor_name=None, time=None, trigger_name=None, _configuration=None):  # noqa: E501
        """SensorLogEntry - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SensorLogEntry, dict):
