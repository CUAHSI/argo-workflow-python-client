...
class IoArgoprojWorkflowV1alpha1S3EncryptionOptions(object):
    ...
    def __init__(self, enable_encryption=None, kms_encryption_context=None, kms_key_id=None, server_side_customer_key_secret=None, _configuration=None):  # noqa: E501
        """IoArgoprojWorkflowV1alpha1S3EncryptionOptions - a model defined in Swagger"""  # noqa: E501
    ...
    def server_side_customer_key_secret(self):
        ...
        ServerSideCustomerKeySecret tells the driver to encrypt the output artifacts using SSE-C with the specified secret.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IoArgoprojWorkflowV1alpha1S3EncryptionOptions, dict):
