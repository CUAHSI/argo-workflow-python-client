...
class IoK8sApiCoreV1Event(object):
    ...
    def __init__(self, action=None, api_version=None, count=None, event_time=None, first_timestamp=None, involved_object=None, kind=None, last_timestamp=None, message=None, metadata=None, reason=None, related=None, reporting_component=None, reporting_instance=None, series=None, source=None, type=None, _configuration=None):  # noqa: E501
    ...
    def involved_object(self, involved_object):
        ...
        """
        if self._configuration.client_side_validation and involved_object is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IoK8sApiCoreV1Event, dict):
