...
class IoArgoprojEventsV1alpha1KafkaConsumerGroup(object):
    ...
    def __init__(self, group_name=None, oldest=None, rebalance_strategy=None, _configuration=None):  # noqa: E501
        """IoArgoprojEventsV1alpha1KafkaConsumerGroup - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(IoArgoprojEventsV1alpha1KafkaConsumerGroup, dict):
